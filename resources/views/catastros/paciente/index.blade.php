    ...
    <div class="col-lg-12">
        ...
        <div class="card card-info">
            <div class="card-header">
                <h3 class="card-title">Catastro de pacientes</h3>
                <div class="card-tools">
                    <a href="{{route('crear_paciente')}}" class="btn btn-outline-secondary btn-sm">
                    ...
                    <tbody>
                        @foreach($datas as $data)
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{route("editar_paciente", ['id' => $data->id])}}" class="btn-accion-tabla tooltipsC" title="Editar este registro">
                                        <i class="fa fa-edit"></i>
                                    </a>
                                    <form action="{{route("eliminar_paciente",  ['id' => $data->id])}}" class="d-inline form-eliminar" method="POST">
                                        @csrf @method("delete")
