    ...
    <div class="col-lg-12">
        ...
        <div class="card card-info">
            <div class="card-header">
                <h3 class="card-title">Nombre del Departamento</h3>
                <div class="card-tools">
                    <a href="{{route('crear_departamento')}}" class="btn btn-outline-secondary btn-sm">
                ...
                <table class="table table-striped table-bordered table-hover" id="tabla-data">
                    ...
                    <tbody>
                        @foreach($datas as $data)
                            <tr>
                                <td>{{$data->id}}</td>
                                <td>{{$data->dpto_nombre}}</td>
                                <td class="col-sm-2"> <div class="text-center"><img  class="rounded float-left" > {!! $data->glyphicon !!} </div></td>
