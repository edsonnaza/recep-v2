...
class ValidarMedico extends FormRequest
{
    /**
        ...
        if ($this->route('id')) {
            return [
               // 'usuario' => 'required|max:50|unique:usuario,usuario,' . $this->route('id'),
                ...
                'email' => 'required|email|max:100|unique:personas,email,persona_nombre,persona_apellido,numero_dni,' . $this->route('id'),
            ...
            return [
                'email' => 'required|email|max:100|unique:personas,email,' . $this->route('id'),
                'persona_nombre' => 'required|max:100',
                'persona_apellido' => 'required|max:100',
