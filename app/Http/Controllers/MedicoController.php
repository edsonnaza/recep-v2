...
use App\Http\Requests\ValidarMedico;
...
class MedicoController extends Controller
{
    ...
    public function index()
    {
       // $datas = Medico::All();//with('personas:id,paciente_nombre,nro_mobil,email,nro_telefono,direccion')->orderBy('id')->get();
        $datas = Persona::whereHas('ClasificacionMedico')->get(); //with('personas:id,paciente_nombre,nro_mobil,email,nro_telefono,direccion')->orderBy('id')->get();

        $especialidades=Especialidad::All();
        // $sedes= Sede::All();
        return view('catastros.medico.index', compact('datas','especialidades'));
    }
    ...
    public function crear()
    {
       // $rols = Rol::orderBy('id')->pluck('nombre', 'id')->toArray();
        ...
        $usuarios=Usuario::All();
         ...
         return view('catastros.medico.crear', compact('tipodni','tipopersona','seguro','estadocivil','profesion','clasificacion','nacionalidad','generos','especialidades','usuarios'));
    }
    ...
    public function guardar(ValidarMedico $request)
    {
        ...
        $persona=Persona::create([
           ...
           $medico=Medico::create([
            ...
            'medico_nombre'=>$request->persona_nombre.' '.$request->persona_apellido,
        ...
        return redirect('medico/crear')->with('mensaje', 'Registro creado con éxito');
    }
    ...
    public function actualizar(ValidarMedico $request, $id)
    {
      ...
      // return redirect('persona')->with('mensaje', 'Registro actualizado con éxito');
               ...
               // dd($request);
                return redirect('medico')->with('mensaje', 'Registro actualizado con éxito');
    }
