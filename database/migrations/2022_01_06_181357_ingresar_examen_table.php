...
class IngresarExamenTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
         Schema::create('ingresarexamen', function (Blueprint $table) {
        $table->bigIncrements('id');
        $table->string('examen_nombre', 192);
    ...
    {
        Schema::dropIfExists('ingresarexamen');
