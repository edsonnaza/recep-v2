...
class TablaRecep extends Migration
{
    ...
    public function up()
    {
        ...
        $table->string('nombre_colaborador',192);
        $table->string('comentario_colaborador',254);
        $table->unsignedBigInteger('id_colaborador_atencion');
