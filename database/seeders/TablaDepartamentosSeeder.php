...
class TablaDepartamentosSeeder extends Seeder
{
    ...
    public function run()
    {
        $now = Carbon::now()->toDateTimeString();
            ...
            array('id' => '4', 'dpto_nombre' => 'COMERCIAL GRANOS', 'glyphicon'=>'<i class="fa fa-tree fa-5x"></i>', 'class'=>'panel panel-success','orden'=>'2','sede_id' => '1', 'created_at' => $now, 'updated_at' => $now),
            ...
            array('id' => '12', 'dpto_nombre' => 'MARKETING', 'glyphicon'=>'<i class="fa fa-lightbulb fa-5x"></i>', 'class'=>'panel panel-primary','orden'=>'10','sede_id' => '1', 'created_at' => $now, 'updated_at' => $now),      
        ];  
