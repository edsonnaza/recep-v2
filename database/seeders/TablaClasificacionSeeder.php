...
class TablaClasificacionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $clasificacion = [
            array('id' => '1', 'nombre_clasificacion' => 'Colaborador',    'created_at' => $now, 'updated_at' => $now),
            array('id' => '2', 'nombre_clasificacion' => 'Usuario del Sistema',   'created_at' => $now, 'updated_at' => $now),
            ...
            array('id' => '5', 'nombre_clasificacion' => 'Sin Especificar',   'created_at' => $now, 'updated_at' => $now)
