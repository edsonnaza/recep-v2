...
class UsuarioAdministradorSeeder extends Seeder
{
    ...
    'id_persona' => '1',
        ...
        //  protected $fillable = ['id', 'persona_nombre', 'persona_apellido', 
        //'full_name_persona','id_tipodni','numero_dni','email','facebook','nro_mobil','nro_telefono' ,
        // 'id_tipopersona','id_estadocivil','id_profesional','id_seguro'];
